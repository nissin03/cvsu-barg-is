                ...
                <div class="col-lg-5">
                        ...
                        <div class="stock-status mb-3">
                            ...
                            @if($hasAttributes)
                                <span class="badge 
                                    ...
                                    id="dynamic-stock-badge"
                                    data-reorder-qty="{{ $product->reorder_quantity }}"
                            ...
                            @else
                                ...
                                @elseif($stockStatus == 'reorder')
                                    <span class="badge bg-warning"><i class="fas fa-exclamation-triangle"></i> Stock ({{ $product->quantity }} left)</span>
                                @else
                            ...
                            <div class="quantity-selector-container d-flex align-items-center gap-3 w-100 mb-3">
                                <div class="quantity-selector d-flex align-items-center">
                                    ...
                                    <input type="number" name="quantity" value="1" min="1" 
                                        class="border-0 text-center mx-1" style="width: 40px;"
                                        aria-label="Quantity">
                                    <button type="button" class="btn p-1" onclick="this.parentNode.querySelector('input').stepUp()">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    ...
                    <div class="social-share">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            class="btn btn-outline-primary btn-sm" target="_blank" rel="noopener" aria-label="Share on Facebook">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            
                            <a href="https://www.instagram.com/?url={{ urlencode(request()->url()) }}" 
                            class="btn btn-outline-danger btn-sm" target="_blank" rel="noopener" aria-label="Share on Instagram">
                            ...
                            class="btn btn-outline-info btn-sm" target="_blank" rel="noopener" aria-label="Share on Twitter">
                                <i class="fab fa-twitter"></i>
                            </a>
                            
                            <button type="button" class="btn btn-outline-secondary btn-sm" id="copy-link-btn" aria-label="Copy link">
                            ...
                            <div class="product-card h-100">
                                <div class="product-image-wrapper">
                                    <div class="swiper-container js-swiper-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ route('shop.product.details', ['product_slug' => $rproduct->slug]) }}" class="product-link">
                                                    <img loading="lazy"
                                ...
                                <div class="product-details" onclick="window.location.href='{{ route('shop.product.details', ['product_slug' => $rproduct->slug]) }}'">
                                    <h3 class="product-title">{{ Str::limit($rproduct->name, 50) }}</h3>
                                    
                                    <p class="product-description">{{ Str::limit($rproduct->short_description ?? 'No description available', 80) }}</p>
