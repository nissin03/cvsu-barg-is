            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap mb-3">
                    <div class="wg-filter flex-grow">
                        <form class="form-search" method="GET" action="{{ route('positions.index') }}">
                            <fieldset class="name">
                                <input type="text" placeholder="Search by name or code..." class="search-input"
                                    ...
                                    title="Search by position name or position code">
                            </fieldset>
                    ...
                    <div class="action-buttons">
                        <a class="tf-button w-auto" href="{{ route('positions.create') }}">
                            <i class="icon-plus"></i>
                            Add New Position
                        </a>
                        <a class="tf-button w-auto" href="{{ route('positions.archive') }}">
                        ...
                        <div class="mobile-cards d-block d-md-none">
                            ...
                            @empty
                                <div class="empty-state">
                                    ...
                                    <p>Start by creating your first position.</p>
                                            ...
                                            <div class="list-icon-function">
                                                ...
                                                <form action="{{ route('positions.destroy', $position->id) }}"
                                                    ...
                                                    <button type="submit" class="item text-warning archive"
                                                        style="border: none; background: none;" title="Archive Position">
                                                        <i class="icon-archive"></i>
                                                    </button>
                                                </form>
                                            </div>
...
@push('scripts')
    <script>
        $(function() {
            ...
            // Archive Position Confirmation
            $('.archive').on('click', function(e) {
                e.preventDefault();
                var form = $(this).closest('form');
                var positionName = $(this)
                    .closest('tr, .mobile-card')
                ...
                Swal.fire({
                    ...customSwalConfig,
                    title: 'Archive Position Confirmation',
                    html: `
                        <div style="text-align: left; line-height: 1.6;">
                            <p style="margin-bottom: 15px; text-align: center;">
                                You are about to archive the following position:
                            </p>
                            <div style="background: linear-gradient(135deg, #fffbeb, #fef3c7); padding: 15px; border-radius: 10px; margin: 15px 0; border-left: 4px solid #f59e0b;">
                                <strong style="color: #92400e; font-size: 16px;">${positionName}</strong>
                            </div>
                            <div style="background: #fef3c7; padding: 12px; border-radius: 8px; margin: 15px 0; border: 1px solid #fcd34d;">
                                <p style="margin: 0; color: #92400e; font-size: 14px;">
                                    ...
                                    <strong>Note:</strong> Archiving will move this position to the archived section. It can be restored later if needed.
                                </p>
                            </div>
                            <p style="margin-top: 20px; color: #64748b; text-align: center;">
                                This action is reversible. The position will remain in the system but will be hidden from the main list.
                            </p>
                        </div>
                    `,
                    customClass: {
                                ...
                                <div style="text-align: center;">
                                    <div style="margin: 20px 0;">
                                        ...
                                        <p style="color: #64748b; margin: 0;">
                                            Please wait while we archive the position...
                                        </p>
                                    </div>
                                </div>
                                <style>
            ...
            $('.mobile-btn, .list-icon-function .item')
                .on('focus', function() {
                    $(this).css({
