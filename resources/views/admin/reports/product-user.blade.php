...
<style>
    ...
    /* Adjust layout for the filters and export buttons */
    .export-pdf-button {
        margin-left: 1rem;
    }
            ...
            <div class="d-flex flex-column flex-md-row gap-3 justify-content-between w-100">
                ...
                <form action="{{ route('admin.generate-input-users') }}" method="POST" id="user-form" class="d-flex gap-2 flex-grow-1 flex-md-grow-0 align-items-center justify-content-md-end w-100">
                    ...
                    <div class="input-group w-auto">
                        ...
                        <!-- Equal Sized Buttons -->
                        <button type="submit" class="btn btn-primary btn-lg fs-5 px-4 d-flex align-items-center">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 d-flex justify-content-end align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <!-- Filter Form -->
                        <form action="{{ route('admin.report-user') }}" method="GET" class="filter-form d-flex gap-3">
                            <div class="row g-2">
                                <div class="col-sm-3">
                                    <select name="week" class="form-select form-select-lg fs-5 py-3 px-4" style="width: 120px;">
                                ...
                                <div class="col-sm-3">
                                    <select name="month" class="form-select form-select-lg fs-5 py-3 px-4">
                                ...
                                <div class="col-sm-3">
                                    <select name="year" class="form-select form-select-lg fs-5 py-3 px-4">
                        ...
                        <form id="pdfForm" action="{{ route('admin.report-user.pdf') }}" method="POST">
                            ...
                            <button id="pdfDownloadButton" type="submit" class="btn btn-danger btn-lg fs-5 px-4">
                ...
                <div class="card-header bg-white py-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0">
                            ...
                            Weekly Registration Analysis ({{ \Carbon\Carbon::createFromFormat('m', $selectedMonth)->format('F') }})
                </h5>
                        </h5>
                    </div>
                </div>
    ...
    <div class="card shadow-sm dashboard-card">
        <div class="card-header bg-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-light btn-sm fs-4" onclick="refreshRecentUsers()">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle custom-table mb-0">
                    <thead class="table-light">
                        <tr>
                            <th class="ps-4 fs-4">USER</th>
                            <th class="fs-4">EMAIL</th>
                            <th class="fs-4">REGISTRATION DATE</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($recentUsers as $user)
                            <tr>
                                ...
                                <td class="fs-4">{{ $user->created_at->format('M d, Y') }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
