                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex gap-2 justify-content-md-end mt-3 mt-md-0 flex-wrap">
                                    <form action="{{ route('admin.report-user') }}" method="GET" id="filter-form"
                                        ...
                                        <select name="month"
                                            ...
                                            @foreach ($availableMonths as $month)
                                                <option value="{{ $month->id }}"
                                                    {{ $month->id == $selectedMonth ? 'selected' : '' }}>
                                                    {{ $month->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <form action="{{ route('admin.report-user.pdf') }}" method="POST" id="pdfForm"
                                        ...
                                        <input type="hidden" name="userRegistrationsByMonth"
                                            value="{{ $userRegistrationsByMonth }}">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom py-4">
                        ...
                        <small class="text-muted">Weekly user registration breakdown for
                            {{ \Carbon\Carbon::createFromFormat('m', $selectedMonth)->format('F') }}</small>
                    </div>
                    <div class="card-body p-4">
                        <div class="mb-4">
