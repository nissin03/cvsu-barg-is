        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 mb-1 text-dark fw-semibold">Sales Charts</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 small text-muted">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('admin.index') }}" class="text-decoration-none text-muted">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Sales Charts</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex gap-2 justify-content-md-end mt-3 mt-md-0 flex-wrap">
                                    ...
                                    <form action="{{ route('admin.downloadPdf') }}" method="POST" id="monthlyPdfForm"
                                        class="d-inline" target="_blank">
                                        @csrf
                                        <input type="hidden" name="total_amount" value="{{ $TotalAmount }}">
                                        <input type="hidden" name="total_reserved_amount"
                                            value="{{ $TotalReservedAmount }}">
                                        <input type="hidden" name="total_picked_up_amount"
                                            value="{{ $TotalPickedUpAmount }}">
                                        <input type="hidden" name="total_canceled_amount"
                                            value="{{ $TotalCanceledAmount }}">
                                        <input type="hidden" name="total_amount_w" value="{{ $TotalAmountW }}">
                                        <input type="hidden" name="total_reserved_amount_w"
                                            value="{{ $TotalReservedAmountW }}">
                                        <input type="hidden" name="total_picked_up_amount_w"
                                            value="{{ $TotalPickedUpAmountW }}">
                                        <input type="hidden" name="total_canceled_amount_w"
                                            value="{{ $TotalCanceledAmountW }}">
                                        <input type="hidden" name="total_amount_d" value="{{ $TotalAmountD }}">
                                        <input type="hidden" name="total_reserved_amount_d"
                                            value="{{ $TotalReservedAmountD }}">
                                        <input type="hidden" name="total_picked_up_amount_d"
                                            value="{{ $TotalPickedUpAmountD }}">
                                        <input type="hidden" name="total_canceled_amount_d"
                                            value="{{ $TotalCanceledAmountD }}">
                                        <input type="hidden" name="selected_year" value="{{ $selectedYear }}">
                                        <input type="hidden" name="selected_month_name"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            try {
                ...
                document.querySelectorAll('[id^="loading-"]').forEach(el => {
                    el.innerHTML =
                        '<div class="alert alert-light border-0 text-center">Error loading chart data</div>';
                });
            }
        });
    </script>
