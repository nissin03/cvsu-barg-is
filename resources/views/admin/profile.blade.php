                ...
                <div class="col-md-6">
                    <div class="text-center">
                        ...
                        <div class="profile-image-container mb-4">
                            ...
                            <div class="image-overlay" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); opacity: 0; transition: opacity 0.3s;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function uploadImage(file) {
        ...
        uploadStatus.innerHTML = '<div class="alert alert-info"><i class="fas fa-spinner fa-spin"></i> Uploading image...</div>';
        ...
        .then(data => {
            if (data.success) {
                uploadStatus.innerHTML = '<div class="alert alert-success"><i class="fas fa-check"></i> ' + data.message + '</div>';
                ...
                uploadStatus.innerHTML = '<div class="alert alert-danger"><i class="fas fa-exclamation-triangle"></i> Upload failed!</div>';
            }
        })
        .catch(error => {
