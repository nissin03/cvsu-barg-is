                            ...
                            <div class="stats-card card border-0 h-100">
                                <div class="card-body p-4">
                                    ...
                                    <div class="stats-content">
                                        ...
                                        <h3 class="stats-value mb-0">₱{{ number_format($dashboardData['total_revenue'], 2) }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-0 shadow-sm rounded-3 h-100">
                                <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                                    <h5 class="mb-0 fw-semibold text-gray-700">
                                        <i class="fas fa-venus-mars me-2 text-primary"></i>Reservations by Gender
                                    </h5>
                                        ...
                                        @foreach ($reservations as $payment)
                                            ...
                                            <tr class="table-row-modern">
                                                    ...
                                                    <div class="customer-info">
                                                        <div class="customer-name" style="font-size: 1.3rem;">
                                                            ...
                                                            @if (optional($payment->user)->utype === 'ADM')
                                                                <span class="badge badge-admin ms-1" style="font-size: 0.9rem;">Admin</span>
                                                            @endif      
                                                        </div>
                                                ...
                                                <td class="text-center type-cell" style="font-size: 1.2rem;">
                                                    @if($facility)
                                                        ...
                                                        @endphp
                                                        <span class="badge badge-{{ str_replace('_', '-', $type) }}" style="font-size: 1rem;">
                                            ...
                                            <td class="text-center date-cell" style="font-size: 1.2rem;">
                                                ...
                                                <td class="text-center price-cell" style="font-size: 1.3rem;">
                                                    <span class="total-price">₱{{ number_format($payment->total_price, 2) }}</span>
                                                </td>
                                                <td class="text-center status-cell" style="font-size: 1.2rem;">
                                                    @if ($payment->status == 'completed')
                                                        <span class="badge badge-completed" style="font-size: 1rem;">Completed</span>
                                                    @elseif($payment->status == 'canceled')
                                                        <span class="badge badge-canceled" style="font-size: 1rem;">Canceled</span>
                                                    @elseif($payment->status == 'reserved')
                                                        <span class="badge badge-reserved" style="font-size: 1rem;">Reserved</span>
                                                    @else
                                                        <span class="badge badge-pending" style="font-size: 1rem;">Pending</span>
                                                    @endif
                                                </td>
...
<style>
    ...
    .name-column { min-width: 200px; width: 20%; }
    .facility-column { min-width: 180px; width: 20%; }
    .type-column { min-width: 100px; width: 10%; }
    .date-column { min-width: 150px; width: 15%; }
    .price-column { min-width: 100px; width: 10%; }
    .status-column { min-width: 120px; width: 10%; }
    .action-column { min-width: 80px; width: 5%; }
    ...
    .badge-individual { background: linear-gradient(45deg, #8b5cf6, #7c3aed); color: white; }
    .badge-whole-place { background: linear-gradient(45deg, #f97316, #ea580c); color: white; }
    .badge-both { background: linear-gradient(45deg, #facc15, #eab308); color: white; }
    .badge-completed { background: linear-gradient(45deg, #10b981, #059669); color: white; }
    .badge-canceled { background: linear-gradient(45deg, #ef4444, #dc2626); color: white; }
    .badge-reserved { background: linear-gradient(45deg, #3b82f6, #1e40af); color: white; }
    .badge-pending { background: linear-gradient(45deg, #f59e0b, #d97706); color: white; }
    .badge-admin {
        background: #f31a1a;
        color: white;
        font-size: 0.8rem;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const departmentChart = new ApexCharts(document.querySelector("#departmentChart"), getDepartmentChartOptions());
    ...
    function getCollegeChartOptions() {
        return {
            ...
            colors: ['#10B981', '#F59E0B', '#3B82F6', '#EC4899', '#8B5CF6', '#6366F1', '#EF4444', '#06B6D4', '#84CC16'],
            dataLabels: {
                enabled: true,
