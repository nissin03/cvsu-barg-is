                ...
                <div class="flex items-center justify-between gap10 flex-wrap mb-3">
                    <div class="wg-filter flex-grow">
                        <form class="form-search" method="GET" action="{{ route('admin.courses.archive') }}">
                            <fieldset class="name">
                                <input type="text" placeholder="Search archived courses..." class="search-input"
                                ...
                                <div class="mobile-card">
                                    ...
                                    <div class="mobile-card-body">
                                        ...
                                        <div class="mobile-card-actions">
                                            ...
                                            <form action="{{ route('admin.courses.force-delete', $course->id) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-cell">
                                            <div class="list-icon-function">
                                                <form action="{{ route('admin.courses.restore', $course->id) }}"
                                                    method="POST" class="d-inline">
                                                    @csrf
                                                    @method('PATCH')
    ...
    <script>
        $(function() {
            ...
            $('.force-delete').on('click', function(e) {
                ...
                var courseName = $(this).closest('tr, .mobile-card').find('.name, .mobile-card-title')
                .text().trim();
                ...
                Swal.fire({
                    ...
                    focusCancel: true,
                    customClass: {
                        popup: 'swal2-popup swal2-warning'
                    }
                }).then((result) => {
