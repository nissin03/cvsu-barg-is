            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            title: 'Success!',
                            html: '<div style="text-align: center; line-height: 1.6;"><strong>' + response.message + '</strong><br><br><small style="color: #666;">The course has been successfully created.</small></div>',
