                    ...
                    <div class="college-card" id="college-0">
                        ...
                        <div class="college-fields">
                            ...
                            <div class="field-group">
                                ...
                                <input 
                                    class="field-input @error('code') error @enderror" 
                                    type="text" 
                            ...
                            <div class="field-group" style="grid-column: 1 / -1;">
                                ...
                                <select 
                                    class="field-select @error('college_id') error @enderror" 
                                    name="college_id" 
                                    aria-required="true" 
                                    required
                                >
                ...
                if (xhr.status === 422) {
                    ...
                    $.each(errors, function(field, messages) {
                        ...
                        if (messages.length > 0) {
                            input.after(`<span class="error-message">${messages[0]}</span>`);
                        }
                    });
                    ...
                    const firstError = $('.field-input.error, .field-select.error').first();
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: xhr.responseJSON?.message || 'An error occurred while updating the course. Please try again.',
                        confirmButtonColor: '#334155',
                        customClass: {
                            popup: 'swal2-error'
                        }
