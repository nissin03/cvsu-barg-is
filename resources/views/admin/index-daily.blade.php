                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="dropdown">
                                <button class="btn btn-outline-light dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-align: left;">
                                    <h5 class="mb-0">Earnings Revenue (Daily)</h5>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end w-100 shadow-sm">
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center p-3" href="{{ route('admin.index') }}">
                                            <i class="fas fa-calendar-week me-2"></i> Monthly Earnings Revenue
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center p-3" href="{{ route('admin.index-weekly') }}">
                                            <i class="fas fa-calendar-day me-2"></i> Weekly Earnings Revenue
                                        </a>
                                    </li>
                                </ul>
                            </div>

                            <form action="{{ route('admin.index-daily') }}" method="GET" class="d-flex flex-grow-2 align-items-center">
                                <!-- Select week -->
                                <select name="week" class="form-select me-2 w-100">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var options = {
            ...
            xaxis: {
                categories: {!! json_encode(collect($dailyDatas)->pluck('DayName')->toArray()) !!},
                title: {
