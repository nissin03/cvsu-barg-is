            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap mb-4">
                    <div class="wg-filter flex-grow">
                        ...
                        <a class="tf-button style-1 w10" href="{{ route('admin.contact.archived') }}"><i
                                class="icon-archive"></i>Archived Contacts</a>
                    </div>
                </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm">
                                    ...
                                    <p class="card-text">
                                        ...
                                        @if (strlen($contact->message) > 100)
                                            <a href="#" class="text-primary view-full-message" data-bs-toggle="modal"
                                                data-bs-target="#messageModal{{ $contact->id }}">...</a>
                                        @endif
                                    </p>
                                ...
                                <div class="card-footer bg-transparent d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('admin.contact.archive', ['id' => $contact->id]) }}"
