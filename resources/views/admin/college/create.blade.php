    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                let collegeCount = 1; // starts with the first one
            ...
            `;
                    ...
                    collegeCount++; // still increment here
                });
                ...
                $(document).on('click', '.remove-college', function() {
                    ...
                    if (id !== 0 && id !== '0') {
                        ...
                        cardToRemove.animate({
                            ...
                            cardToRemove.remove();
                            updateCollegeNumbers(); // this will also fix collegeCount now
                        });
                    } else {
                ...
                function updateCollegeNumbers() {
                    ...
                    // ✨ KEY LINE: sync the counter with how many forms are visible
                    collegeCount = $('.college-card').length;
                }
