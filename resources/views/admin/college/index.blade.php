                    ...
                    <div class="flex items-center justify-between gap10 flex-wrap mb-3">
                        <div class="wg-filter flex-grow">
                            <form class="form-search" method="GET" action="{{ route('admin.colleges.index') }}">
                                <fieldset class="name">
                                    <input type="text" placeholder="Search colleges..." class="search-input" name="search"
                        ...
                        <div class="action-buttons">
                            <a class="tf-button w-auto" href="{{ route('admin.colleges.create') }}"><i class="icon-plus"></i>Add New College</a>
                                    ...
                                    <div class="mobile-card">
                                        ...
                                        <div class="mobile-card-body">
                                            <div class="mobile-card-actions">
                                                <a href="{{ route('admin.colleges.edit', $college->id) }}" class="btn btn-sm btn-primary mobile-btn">
                                                    <i class="icon-edit-3"></i> Edit
                                                </a>
                                                <form action="{{ route('admin.colleges.destroy', $college->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-cell">
                                                <div class="list-icon-function">
                                                    <a href="{{ route('admin.colleges.edit', $college->id) }}" title="Edit College">
                                                        <div class="item edit">
                                                    ...
                                                    <form action="{{ route('admin.colleges.destroy', $college->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="item text-danger delete" style="border: none; background: none;" title="Archive College">
                ...
                if ($(window).width() > 768) {
                    $('.list-icon-function .item').each(function() {
                        ...
                        if (title) {
                            $(this).hover(
                                function() {
                                    const tooltip = $('<div class="custom-tooltip">' + title + '</div>').css({
                                        'position': 'absolute',
                                        'background': '#1e293b',
                                        'color': 'white',
                                        'padding': '6px 10px',
