    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                <h3 class="page-title">Archived Colleges</h3>
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Archived Colleges</div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="mobile-cards d-block d-md-none">
                            ...
                            @empty
                                <div class="empty-state">
                                    <p>No archived colleges found.</p>
                                </div>
                            @endforelse
                        </div>
                        ...
                        <table class="table table-striped table-bordered d-none d-md-table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center empty-state">No archived colleges found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    html: `
                        <div style="text-align: left; line-height: 1.6;">
                            ...
                            <div style="background: #f8f9fa; padding: 15px; border-radius: 6px; margin: 15px 0; border-left: 4px solid #dc3545;">
                                <strong style="color: #dc3545;">${collegeName}</strong>
                            </div>
                    ...
                    html: `
                        <div style="text-align: left; line-height: 1.6;">
                            ...
                            <div style="background: #d1edff; padding: 15px; border-radius: 6px; margin: 15px 0; border-left: 4px solid #28a745;">
                                <strong style="color: #155724;">${collegeName}</strong>
                            </div>
                            <div style="background: #d4edda; padding: 12px; border-radius: 6px; margin: 15px 0;">
                                This college will be restored to active status and will be available for normal operations again.
                            </div>
