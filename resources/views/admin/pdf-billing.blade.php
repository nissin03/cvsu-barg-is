        ...
        <table class="header-table">
            <tr>
                <td style="text-align: right; width: 10%;">
                    <img src="{{ public_path('assets/images/logo/cvsu-logo.png') }}" alt="Cavite State University Logo">
                </td>
                
                <td class="center-text" style="width: 80%;">
                ...
                <td style="text-align: left; width: 10%;">
                    <img src="{{ public_path('assets/images/logo/BaRG-logo.jpg') }}" alt="BaRG Logo">
                </td>
            </tr>
        </table>
    </div>
