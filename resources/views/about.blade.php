                    ...
                    <div class="container">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-lg-6 ps-lg-6">
                                <h3>Vision</h3>
                                <hr>
                                <p>The Premier University in historic Cavite globally recognized for excellence in character
                                    development, academics, research, innovation and sustainable community engagement.</p>
                                <h3>Mission</h3>
                                <hr>
                                <p>Cavite State University shall provide excellent, equitable, and relevant educational
                    ...
                    <div class="container">
                        <div class="row justify-content-between">
                            <div class="col-lg-6 ps-lg-6">
                                <h3>BaRG Vision</h3>
                                <hr>
                                <p>The office of Production and Resource Generation of Cavite State University as an
                                    aggressive arm of the University in resource generation and an entrepreneurship model of
                                    SUC's in this country.</p>
                                <h3>BaRG Mission</h3>
                                <hr>
                                <p>To vigorously pursue a sustainable resource generation program using the University's
                                    resources while developing the capabilities of its staff, faculty, students and other
                                    partners.</p>
                            </div>
                            <div class="col-lg-6 mb-6 mb-lg-0">
                                <div class="imgs-grid">
                    ...
                    <div class="container">
                        <div class="row justify-content-between">
                            <div class="col-lg-6 ps-lg-6">
                                ...
                                <hr>
                                <p>We commit to the highest standards of education. Value our stakeholder. Strive for
