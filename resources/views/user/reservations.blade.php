                            ...
                            <div class="accordion-item mb-3 shadow-sm border rounded">
                                <h2 class="accordion-header" id="headingReservation{{ $availability->id }}">
                                    <button class="accordion-button d-flex justify-content-between align-items-center"
                                        ...
                                        data-bs-target="#collapseReservation{{ $availability->id }}" aria-expanded="false"
                                        ...
                                        <span>
                                            ...
                                            <small class="text-muted">Placed on
                                                {{ $availability->created_at->format('M d, Y') }}</small>
                                        </span>
                                        <span>
                                            <span class="badge">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">
                                            ...
                                            <div>
                                                <p><strong>Total Price:
                                                    </strong>&#8369;{{ number_format($availability->total_price, 2) }}</p>
                                            </div>
                                        </div>

                                        <!-- Reservation Footer Details -->
                                        <div class="mt-3 d-flex justify-content-between align-items-center">
                                            <a href="{{ route('user.reservation_details', ['availability_id' => $availability->id]) }}"
