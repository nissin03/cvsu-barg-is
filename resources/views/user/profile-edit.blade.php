                    ...
                    <div class="col-md-9 mb-4">
                        <div class="bg-white p-4 border rounded shadow-sm profile-content h-100">
                            ...
                            <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="mt-4 mb-3">
                                    <button type="submit" class="btn btn-black" id="updateProfileBtn" disabled>Update
                                        Profile</button>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateFieldsVisibility(role) {
                ...
                if (othersFields) othersFields.style.display = 'none';
                if (!role) {
                    return;
                }
                ...
                if (role === 'student') {
                    ...
                    if (othersFields) othersFields.style.display = 'block';
                }
                ...
                fetch(`/colleges/${collegeId}/courses`)
                    ...
                    .catch(error => {
                        ...
                        courseSelect.innerHTML =
                            '<option value="" disabled selected>Error loading courses</option>';
                        validateForm();
                    });
            }
