                ...
                <div style="margin-left: 50px;">
                   ...
                   @if ($facility->prices->isNotEmpty())
                    ...
                    @if ($facility->facilityAttributes->first() && $facility->facilityAttributes->first()->whole_capacity)
                        <p><strong>Whole Capacity: </strong> {{ $facility->facilityAttributes->first()->whole_capacity }}</p>
                    @endif
                    ...
                    @if ($roomNumbers->isNotEmpty())
                        ...
                        @endphp
                        <p><strong>Room(s) Name: </strong>Room {{ $firstRoom }}{{ $firstRoom != $lastRoom ? ' - ' . $lastRoom : '' }}</p>
                    @endif
                    @php
