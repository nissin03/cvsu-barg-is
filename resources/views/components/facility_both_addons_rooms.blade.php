...
<style>
    #{{ $section }}AddonsModal .selected-addons-display .client-type {
        min-width: 220px;
        width: 100%;
        margin-bottom: 15px;
        padding: 15px;
    ...
    #{{ $section }}AddonsModal .selected-addons-display .client-type .addon-name {
        font-weight: 600;
        margin-bottom: 8px;
        color: #111827;
        font-size: 15px;
    ...
    #{{ $section }}AddonsModal .selected-addons-display .client-type .addon-price {
        font-weight: 500;
        margin-bottom: 6px;
        color: #0066cc;
        font-size: 14px;
    ...
    #{{ $section }}AddonsModal .selected-addons-display .client-type .addon-quantity {
        font-size: 0.9em;
        color: #374151;
    }
                                                ...
                                                @if($addon->is_based_on_quantity)
                                                    <div class="quantity-control">
                                                        ...
                                                        <input id="{{ $section }}_addon_quantity-{{ $addon->id }}" 
                                                            type="number" 
                                                            class="form-control addon-quantity-input addon-quantity"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function hasSelectedAddons() {
            ...
            document.querySelectorAll('#{{ $section }}AddonsModal .addon-quantity-input').forEach(input => {
        ...
        document.addEventListener('input', function(e) {
            if (e.target.classList.contains('addon-quantity-input') && e.target.closest('#{{ $section }}AddonsModal')) {
