                            ...
                            @foreach ($perUnitAddons as $addon)
                                <div class="addon-card mb-3">
                                    <div class="accordion-item">
                                        ...
                                        <div id="perUnitCollapse{{ $addon->id }}" class="accordion-collapse collapse"
                                                ...
                                                @else
                                                    <div class="form-check">
                                                        <input class="form-check-input addon-checkbox" type="checkbox"
                                                            ...
                                                            name="addon_checkbox[{{ $addon->id }}]" value="1"
                                                ...
                                                @if ($addon->billing_cycle === 'per_day')
                                                    <div class="calendar-control mt-3">
                                                        ...
                                                        <input type="hidden"
                                                            ...
                                                            value="">
                                                        <input type="hidden" id="addon_date_to-{{ $addon->id }}"
                                                            name="addon_date_to[{{ $addon->id }}]" value="">
                                                        <input type="hidden"
                                                    ...
                                                    <div class="nights-control mt-3">
                                                        ...
                                                        <input id="addon_nights-{{ $addon->id }}" type="number"
                                                            class="form-control nights-input"
                                                            name="addon_nights[{{ $addon->id }}]" value="0"
                                                            min="0" step="1"
                                                            data-addon-id="{{ $addon->id }}"
                                                ...
                                                @if ($addon->is_based_on_quantity)
                                                    <div class="quantity-control">
                                                        ...
                                                        <input id="addon_quantity-{{ $addon->id }}" type="number"
                                                            ...
                                                            step="1" data-addon-id="{{ $addon->id }}"
                                                            data-price-type="per_night" placeholder="Enter quantity">
                                                    </div>
                                                @else
                                                    <div class="form-check">
                                                        <input
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.addEventListener('show.bs.modal', function(e) {
                ...
                document.querySelectorAll('.modal').forEach(function(m) {
                    if (m !== e.target) m.setAttribute('inert', '');
                });
            });
            ...
            document.addEventListener('hidden.bs.modal', function() {
                document.querySelectorAll('.modal[inert]').forEach(function(m) {
